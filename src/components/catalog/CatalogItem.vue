<template>
    <div class="catalog-item">
        <catalog-popup 
            ...
            <div class="catalog-item__popup">
                <div class="catalog-item__image-wrap">
                    <img :src="product_data.image" :alt="product_data.name" class="catalog-item__image">
                </div>
        ...
        <div class="catalog-item__btns">
            <button class="btn catalog-item__show-info"
                @click="showPopup"
                >Show info</button>
            <button class="btn catalog-item__btn" @click="addToCart">Add to cart</button>
        </div>
    </div>
</template>
